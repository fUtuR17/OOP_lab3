...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "v1.15.0"
  WORKING_DIRECTORY "/workspaces/OOP/lab1/build/_deps/googletest-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.15.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.15.0")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/OOP/lab1/build/_deps/googletest-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/OOP/lab1/build/_deps/googletest-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
